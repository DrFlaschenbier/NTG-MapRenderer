...
namespace TsMap
{
    public class TsMapRenderer
    {
        ...
        private readonly Font _defaultFont = new Font("Segoe UI", 10.0f, FontStyle.Bold);
        private readonly SolidBrush _cityShadowColor = new SolidBrush(Color.FromArgb(230, 17, 24, 32));
        ...
        public void Render(Graphics g, Rectangle clip, float scale, PointF startPoint, MapPalette palette, RenderFlags renderFlags = RenderFlags.All)
        {
            ...
            {
                var ferryPen = new Pen(palette.FerryLines, 42) { DashPattern = new[] { 7f, 7f }, StartCap = LineCap.Round, EndCap = LineCap.Round };
